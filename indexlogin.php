<?php
  ...
  include("db.php");
  //Seguridad de sessiones en paginacion
...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <a class="active"><img class="img-responsive" src="img/logopalujo.png" style="width:90px; margin-left:69px" alt=""></a>
            <a href="cerrar_sesion.php" class="sesion1"><i class="fa fa-user me-sm-1"></i>
                <span style="margin-right:74px" class="d-sm-inline d-none" >Cerrar Sesion</span></a>
...
<section id="servicios" class="cards-wrapper">
  <div class="card-grid-space">
    <a class="card" href="reserva/habitacionp.php" style="--bg-img: url(../img/2hab.jpg)">
      <div>
        <h1>Pequeña</h1>
  ...
  <div class="card-grid-space">
    ...
    <a class="card" href="reserva/habitacionm.php" style="--bg-img: url(../img/1hab.jpg)">
      <div>
        <h1>Mediana</h1>
  ...
  <div class="card-grid-space">
    ...
    <a class="card" href="reserva/habitaciong.php" style="--bg-img: url(../img/3hab.jpg)">
      <div>
        <h1>Grande</h1>
...
<section class="cards-wrapper">
  ...
  <div class="card-grid-space">
    <a  class="card" href="reserva/salonp.php" style="--bg-img: url(../img/1salo.jpg)">
      <div>
        <h1>Pequeño</h1>
  ...
  <div class="card-grid-space">
    <a class="card" href="reserva/salonm.php" style="--bg-img: url(../img/2salo.jpg)">
      <div>
        <h1>Mediano</h1>
  ...
  <div class="card-grid-space">
    ...
    <a class="card" href="reserva/salong.php" style="--bg-img: url(../img/3salo.jpg)">
      <div>
        <h1>Grande</h1>
...
<i class="fa-brands fa-google-plus" style="color:white;" aria-hidden="true"></i>
